...
class _ShippingInfoState extends State<ShippingInfo> {
  ...
  onPressProceed(context) async {
    ...
    var sellerWiseShippingOptionErrors =
    ...
    print(sellerWiseShippingOptionErrors.length);
    print(jsonEncode(_sellerWiseShippingOption));

    if (sellerWiseShippingOptionErrors.isNotEmpty && carrier_base_shipping.$) {
                    ...
                    Container(
                      ...
                      child: Text(
                        "${_deliveryInfoList[sellerArrayIndex]
                                .carriers!
                                .data![carrierIndex]
                                .transitTime} ${LangText(context).local.day_ucf}",
                        maxLines: 2,
                        style: TextStyle(
                            fontSize: 13,
                            color: MyTheme.dark_font_grey,
